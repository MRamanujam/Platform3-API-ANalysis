...
var rulesObj = {
    ...
    language: "GROOVY",
    code: "log.info('message rules...');",
    compilable: true,
    description: "Test Message Rules API",
    contexts: [],
    plugins: [ ],
    messageId: "1001"
}
